                ...
                <div class="flex -mx-4 flex-row relative">
                    ...
                    <div class="px-4 relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                            ...
                            <img src="{{$product->galleries()->exists() ? Storage::url($product->galleries->first()->url) : "data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="}}" alt=""class="w-full h-full object-cover object-center"/>
                        </div>
